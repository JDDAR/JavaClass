...
public class ListaMedico {
    ...
    public static void main(String[] args) {
        ...
        listaMedico.add(new Medico("Axel", "Jass", 1010218106));
        listaMedico.add(new Medico("Joaquin", "Will", 12456854));
        ...
        try {
            ...
            System.err.println("Debe ingresar una posicion existente ente el 0 y el " + listaMedico.size());
